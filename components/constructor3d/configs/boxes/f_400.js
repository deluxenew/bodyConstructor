...
const variants = ["397_716_0_solid_1"]
...
const facadeVariant1 = () => {
	...
	facadeLeft.position.set(-1.99, legsHeight / 2, depth /2)
...
export const f_400 = (facadeName, onlyFacade) => {
	let facadeGroup

	if (facadeName) {
		if (!variants.includes(facadeName)) return
		const facades = {
			"397_716_0_solid_1": facadeVariant1(),
		}
