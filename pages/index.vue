  ...
  div.inner-page
    div.page
      ...
      div.constructor
        div.column.preview
          | 2132
          canvas(ref="canvas" width="800px" height="600px")
        div.column.config
          | 123123
</template>

<script>
import { Scene, PerspectiveCamera, WebGLRenderer, PlaneGeometry, MeshStandardMaterial, TextureLoader, Mesh, RepeatWrapping, Math, BoxGeometry, CylinderGeometry,
  Object3D, SpotLight, DirectionalLightHelper } from 'three';
...
export default {
  ...
  mounted() {
    ...
    const camera = new PerspectiveCamera( 45, /*window.innerWidth*/1000 / window.innerHeight, 4, 100 );
