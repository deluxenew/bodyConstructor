  ...
  export default {
    ...
    methods: {
      ...
      selectCase() {
        ...
        const recursiveFind = (obj, name) => {
          if (!obj || !obj.parent) return null
          const parent = obj.parent
          if (parent.name === name) return parent
          else return recursiveFind(parent, name)
        }
    ...
    mounted() {
      ...
      // // makeXYZGUI(gui, vm.body.position, 'body', updateLight);
      // makeXYZGUIR(gui, vm.body.rotation, 'body.rotation', /*updateLight*/);
      ...
      function render() {
        ...
        if (vm.selectedCase) {
          ...
          if (vm.openCheck) {
            ...
            leftDoor.rotation.y = fromTo(leftDoor.rotation.y, 0, Math.degToRad(-90), Math.degToRad(2.5));
            rightDoor.rotation.y = fromTo(rightDoor.rotation.y, 0, Math.degToRad(90), Math.degToRad(2.5));
          } else {
            leftDoor.rotation.y = fromTo(leftDoor.rotation.y, Math.degToRad(-90), 0, Math.degToRad(2.5));
            rightDoor.rotation.y = fromTo(rightDoor.rotation.y, Math.degToRad(90), 0, Math.degToRad(2.5));
          }
        }
